...
public class RedisUtils {
     ...
     * @return
     */
    public Object hmGet (String key, Object[] hashFields){
        HashOperations<String, Object, Object>  hash = redisTemplate.opsForHash();
        if (hashFields.length > 0) {
            if(hashFields.length == 1) {
                return hash.get(key, hashFields[0]);
            }
            return hash.multiGet(key, Arrays.asList(hashFields));
        }
        return null;
    }
     ...
     * @return
     */
    public Object hmdel(String key, Object[] field) {
        HashOperations<String, Object, Object>  hash = redisTemplate.opsForHash();
        return hash.delete(key, field);
    }
